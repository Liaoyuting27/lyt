...
flags = tf.app.flags
flags.DEFINE_string("data_dir","D://fiberhome/mnist-data")
...
#定义ps的地址
flags.DEFINE_string("ps_hosts","192.168.122.223:2222")
flags.DEFINE_string("work_hosts","192.168.122.3:2222")#有多的worker用，隔开
flags.DEFINE_string("job_name",None)
flags.DEFINE_string("task_index",None)
